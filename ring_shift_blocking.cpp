...
int main(int argc, char* argv[]) {
    ...
    for (int iteration=0; iteration < maxIterations; iteration++) {
        if (world_rank == 0) {
            ...
            MPI_Recv(recbuf, messageSize, MPI_UNSIGNED_CHAR, world_size - 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
            ...
            MPI_Recv(recbuf, messageSize, MPI_UNSIGNED_CHAR, world_rank - 1, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
